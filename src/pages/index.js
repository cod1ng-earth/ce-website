          ...
          <Box>
            <Fade left ssrFadeout distance="20px" duration={1000}>
              ...
              <Paragraph fill>
                ...
                community driven meetup that embraces a knowledge exchange
        ...
        <Box>
          <Fade right ssrFadeout distance="20px" duration={1000}>
            ...
            <Paragraph fill>
              ...
              learning sets, virtual clusters providing computing power for
              scaled applications and command line tools that improve your
              workflow: it’s nearly impossible to keep an eye on everything.
            </Paragraph>
            <Paragraph fill>
              ...
              coder community: every software development related topic is
              welcome here, every developer with whatever skill level will take
              away something new on every session, every question may be asked
              and everyone should have a good time. There’s only one golden
              rule: don’t bore us with bs, talks have to be hands on, the must
              contain at least 1 line of code and in the best case they’re
              massively supported by demos.
            </Paragraph>
          </Fade>
        </Box>
      </ResponsiveGrid>
      ...
      <ResponsiveGrid>
        <Fade left ssrFadeout distance="20px" duration={1000}>
          ...
          <Paragraph fill color="light-5">
            ...
            software stack that you’re using in your startup, this is the place
            to present. If you seek for an opportunity to spread the evangelism
            of the next big programming language: give a talk at coding berlin.
            We’re embracing developers and we’re just waiting for you.
          </Paragraph>
        </Fade>
      </ResponsiveGrid>
    </Box>
